...
export default function PhotoCard({ photo, onLike, onSelect, token }: Props) {
  ...
  return (
    <>
      <div className="group relative bg-stone-100 overflow-hidden aspect-square">
        ...
        {/* Status badges (always visible when active) */}
        ...
        <div className="absolute bottom-0 left-0 right-0 p-2 flex items-center justify-between opacity-0 group-hover:opacity-100 transition-opacity duration-200">
          ...
          <div className="flex gap-1.5">
            ...
            <button
              ...
              className="p-2 bg-stone-950/70 text-white rounded hover:bg-stone-900 transition-all disabled:opacity-50"
              title="Download"
            >
              <Download size={13} />
            </button>
