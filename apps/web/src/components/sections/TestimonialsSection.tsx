    ...
    <section className="py-24 md:py-36 bg-stone-900 text-white">
      <div className="container-wide">
        <div className="text-center mb-16">
          <p className="text-xs tracking-ultra-wide uppercase text-stone-500 mb-3">
            Kind Words
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          {testimonials.map((t, i) => (
            <div key={i} className="border-t border-stone-700 pt-8">
              <p className="text-stone-300 text-lg font-serif font-light leading-relaxed mb-8 italic">
                &ldquo;{t.quote}&rdquo;
              </p>
