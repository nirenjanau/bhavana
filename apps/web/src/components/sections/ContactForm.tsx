...
export default function ContactForm() {
  ...
  if (status === "success") {
    return (
      <div className="space-y-6 md:space-y-8">
        {/* Success card */}
        <div className="p-5 md:p-6 bg-stone-100 border border-stone-200 rounded-sm">
          <p className="text-xs tracking-widest uppercase text-stone-400 mb-2 md:mb-3">Enquiry Submitted</p>
          <p className="font-serif text-xl md:text-2xl text-stone-900 italic mb-2 md:mb-3">
            Thank you!
          </p>
        ...
        <a
          ...
          className="flex items-center justify-center gap-3 bg-[#25D366] text-white text-xs tracking-widest uppercase py-4 md:py-5 px-6 md:px-8 hover:bg-[#1ebe5d] transition-colors duration-300 w-full"
        >
          <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 md:w-5 md:h-5 shrink-0" aria-hidden="true">
        ...
        <button
          ...
          className="block text-xs tracking-widest uppercase text-stone-400 border-b border-stone-200 pb-0.5 hover:text-stone-900 hover:border-stone-900 transition-colors duration-300 mx-auto"
        >
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 md:space-y-8">
      ...
      {status === "error" && (
        <div className="p-4 bg-red-50 border border-red-100 text-red-700 text-sm rounded-sm">
      ...
      <button
        ...
        className="w-full bg-stone-900 text-white text-xs tracking-widest uppercase py-4 md:py-5 hover:bg-stone-700 transition-colors disabled:opacity-60"
      >
